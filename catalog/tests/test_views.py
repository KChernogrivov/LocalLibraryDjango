...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user1 = User.objects.create_user(username='user', password='useruser1')
        test_user1.save()
        test_user2 = User.objects.create_user(username='librarian', password='useruser1')
        test_user2.save()
    ...
    def test_logged_in_uses_correct_template(self):
        login = self.client.login(username='user', password='useruser1')
        resp = self.client.get(reverse('my-borrowed'))
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        login = self.client.login(username='librarian', password='useruser1')
